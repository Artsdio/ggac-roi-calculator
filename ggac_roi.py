...
# ── PARSER EXCEL MODAL_GGAC (DIPERBAIKI V3) ─────────────────────────────────
def parse_modal_excel(file_bytes):
    """
    Baca Modal_GGAC_v3.xlsx.
    Struktur V3: Ringkasan ada di baris 31-36.
    Item Fase 1: baris 6-9, Fase 2: baris 14-18, Penunjang: baris 22-27.
    """
    ...
    if "Investasi Investor" in wb.sheetnames:
        ...
        # Ini adalah sumber kebenaran utama untuk angka summary
        gym_f1   = val("B31")  # Peralatan gym Fase 1
        gym_f2   = val("C32")  # Peralatan gym Fase 2 (subtotal)
...
with st.expander("📂 Import dari Excel — Modal_GGAC_v3.xlsx", expanded=False):
    ...
    if uploaded is not None:
        try:
            ...
            # ── Ambil nilai dari Excel (Menggunakan data dari Ringkasan) ──
