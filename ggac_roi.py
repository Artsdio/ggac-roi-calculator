                ...
                st.markdown(f"""
                 <div style="background:#E8F5EE;border-radius:10px;padding:.75rem 1rem;border-left:4px solid #0F6E56">
                   ...
                   <div style="font-size:11px;color:#888780;line-height:1.8">
                     ...
                     <div style="display:flex;justify-content:space-between;border-top:1px solid #ccc;margin:4px 0;padding-top:4px"><span>Subtotal</span><span style="font-family:DM Mono,monospace;font-weight:600">Rp {rp(subtotal_f1)}</span></div>
                     <div style="display:flex;justify-content:space-between;color:#0F6E56"><span>Buffer {int(buf_pct*100)}%</span><span style="font-family:DM Mono,monospace;font-weight:600">Rp {rp(buffer_f1)}</span></div>
                   </div>
            ...
            with col_s2:
                st.markdown(f"""
                 <div style="background:#FDF3E3;border-radius:10px;padding:.75rem 1rem;border-left:4px solid #854F0B">
                   ...
                   <div style="font-size:11px;color:#888780;line-height:1.8">
                     <div style="display:flex;justify-content:space-between"><span>{len(xl_data.get('fase2_gym',[]))} item · semua Qty=0</span></div>
                     <div style="display:flex;justify-content:space-between;margin-top:4px"><span>Subtotal Fase 1+2</span><span style="font-family:DM Mono,monospace;font-weight:600">Rp {rp(subtotal_f12)}</span></div>
                     <div style="display:flex;justify-content:space-between;color:#854F0B"><span>Buffer {int(buf_pct*100)}%</span><span style="font-family:DM Mono,monospace;font-weight:600">Rp {rp(buffer_f12)}</span></div>
                   </div>
